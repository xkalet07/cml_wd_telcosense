...
#target_dir = 'TelcoRain/merged_data_preprocessed_long/'
target_dir = 'TelcoRain/merged_data_preprocessed_full/'
...
for technology in ['summit', 'summit_bt', '1s10', 'ceragon_ip_20']: # 'ceragon_ip_10' #doesnt have a temperature 
    ...
    for k in range(len(file_list)//2):    
        ...
        ## CLASS BALANCE
        #cml = preprocess_utility.balance_wd_classes(cml,2000)
