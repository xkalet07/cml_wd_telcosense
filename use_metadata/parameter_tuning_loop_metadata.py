...
for file in file_list:
    ...
    cml_A_ip = file[file.rfind('ipA_')+4:file.rfind('_ipB')]
    metadata = metadata_all.loc[(metadata_all['IP_address_A'] == cml_A_ip) | (metadata_all['IP_address_B'] == cml_A_ip)]
    metadata.drop(columns=['IP_address_A','IP_address_B'])
